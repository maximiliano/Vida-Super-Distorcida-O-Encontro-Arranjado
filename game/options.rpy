...
init -1 python hide:
    ...
    config.window_title = u"Vida Super Distorcida: Encontro Arranjado"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Vida Super Distorcida: Encontro Arranjado"
    config.version = "0.0"
...
python early:
    config.save_directory = "Vida Super Distorcida: Encontro Arranjado-1458506940"
